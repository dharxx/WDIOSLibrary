...
Pod::Spec.new do |s|
  s.name             = 'WDIOSLibrary'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WDIOSLibrary.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/WDIOSLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Dhanu Saksrisathaporn' => 'dharxx@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/WDIOSLibrary.git', :tag => s.version.to_s }
